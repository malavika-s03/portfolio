...
import { scrollAppear, projectBlockAppear, SCROLL_EASE } from '@/lib/animations';
  ...
  return (
    <div className="bg-black w-full relative overflow-hidden" style={{ height: '92.42vw' }}>
      ...
      <motion.div {...projectBlockAppear}>
        ...
        <div className="absolute" style={{ left: '55.31vw', top: '29.53vw' }}>
          <Link
            to={yuluLink}
      ...
      <motion.div {...projectBlockAppear}>
        ...
        {vectorVault.floatingImages && (
          <>
            <img src={vectorVault.floatingImages[0]} alt="" loading="lazy" className="absolute object-contain" style={{ left: '83.24vw', top: '58.31vw', width: '8.76vw', height: '8.32vw', maxWidth: 'none' }} />
            <img src={vectorVault.floatingImages[1]} alt="" loading="lazy" className="absolute object-contain" style={{ left: '50.00vw', top: '67.95vw', width: '8.37vw', height: '8.39vw', maxWidth: 'none' }} />
            <img src={vectorVault.floatingImages[2]} alt="" loading="lazy" className="absolute object-contain" style={{ left: '65.84vw', top: '60.27vw', width: '4.20vw', height: '7.00vw', maxWidth: 'none' }} />
            <img src={vectorVault.floatingImages[3]} alt="" loading="lazy" className="absolute object-contain" style={{ left: '78.78vw', top: '63.84vw', width: '6.31vw', height: '6.91vw', maxWidth: 'none' }} />
            <img src={vectorVault.floatingImages[4]} alt="" loading="lazy" className="absolute object-contain" style={{ left: '58.50vw', top: '67.25vw', width: '6.95vw', height: '6.97vw', maxWidth: 'none' }} />
          </>
        )}
        <p
          className="absolute font-normal text-[#fffbfb]"
        ...
        <div className="absolute" style={{ left: '6.88vw', top: '78.05vw' }}>
          <Link
            to={vvLink}
            className="inline-flex items-center justify-center bg-white text-black rounded-full font-medium hover:opacity-80 transition-opacity no-underline"
            style={{ width: '11.17vw', height: '3.75vw', fontSize: '1.09vw', lineHeight: '1.56vw' }}
  ...
  return (
    <div className="bg-white w-full relative overflow-hidden" style={{ height: '99.61vw' }}>
      ...
      <motion.div {...projectBlockAppear}>
        ...
        <div className="absolute" style={{ left: '55.31vw', top: '27.19vw' }}>
          <Link
            to={peakmindLink}
      ...
      <motion.div {...projectBlockAppear}>
        ...
        <div className="absolute" style={{ left: '6.88vw', top: '71.02vw' }}>
          <Link
            to={zohoLink}
            className="inline-flex items-center justify-center rounded-full font-medium hover:opacity-80 transition-opacity no-underline"
            style={{ width: '11.17vw', height: '3.75vw', fontSize: '1.09vw', lineHeight: '1.56vw', backgroundColor: '#000000', color: '#ffffff' }}
